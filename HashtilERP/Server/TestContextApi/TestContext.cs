...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<KOrder>(entity =>
            {
                ...
                entity.Property(e => e.MarketingDate).HasColumnType("date");
            ...
            modelBuilder.Entity<KOrderAuditTable>(entity =>
            {
                ...
                entity.Property(e => e.KOrderAuditTableId).HasColumnName("K_OrderAuditTableId");
            ...
            modelBuilder.Entity<KOrderForTest>(entity =>
            {
                ...
                entity.ToTable("K_Order_For_Test");
            ...
            modelBuilder.Entity<KOrderPassports>(entity =>
            {
                ...
                entity.Property(e => e.KPassportNum).HasColumnName("K_PassportNum");

                entity.Property(e => e.SelectedAvg).HasColumnName("SelectedAVG");
            ...
            modelBuilder.Entity<KOrderRemark>(entity =>
            {
                ...
                entity.Property(e => e.KOrderRemarkId).HasColumnName("K_OrderRemarkId");

                entity.Property(e => e.KOrderRemarkStamp)
                    .HasColumnType("datetime")
                    .HasColumnName("K_OrderRemarkStamp");
            ...
            modelBuilder.Entity<KPassport>(entity =>
            {
                ...
                entity.Property(e => e.Gamlon).HasMaxLength(10);
                ...
                entity.Property(e => e.Hamama).HasMaxLength(10);
            ...
            modelBuilder.Entity<KPassportForTest>(entity =>
            {
                entity.HasKey(e => e.KPassportId)
                    .HasName("PK_K_PassportId_For_Test");

                entity.ToTable("K_Passport_For_Test");
