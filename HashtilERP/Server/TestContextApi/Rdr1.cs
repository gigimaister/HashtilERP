...
namespace HashtilERP.TestContextApi
{
    public partial class Rdr1
    {
        ...
        public string UMishkalelef { get; set; }
        public string UFromInvt { get; set; }
        public int? UPassNum { get; set; }
        public string UProdNum { get; set; }
        public string UCustSeed { get; set; }
        public string UDrctDebt { get; set; }
        public int? UOrdrNum { get; set; }
        public int? ULineNum { get; set; }
        public decimal? UQuanInvt { get; set; }
        public DateTime? UDateEnd { get; set; }
        public DateTime? UPassExt { get; set; }
        public int? UGrowDays { get; set; }
        public string UPassport10 { get; set; }
        public string UMemoza { get; set; }
        public string UHamama { get; set; }
        public string UGamlon10 { get; set; }
        public string UMagash10 { get; set; }
        public string UBsyMsupId { get; set; }
        public decimal? UBsyFprice { get; set; }
        public string UPrintLine { get; set; }
        public int? ULastPrice { get; set; }
        public DateTime? ULpdate { get; set; }
        public int? UOrLastPrice { get; set; }
        public DateTime? UOrLpdate { get; set; }
    }
}