     ...
     .HasForeignKey(x => x.K_PassportId);
        ...
        .HasForeignKey(x => x.K_PassportId);
          ...
          .WithOne();
           ...
           .ToTable("@PASSPROD", "dbo")
           .Property(x => x.DocNum).HasConversion<string>();

          //  modelBuilder.Entity<Passprod>()
          //.ToTable("@PASSPROD", "dbo")     
          //.HasOne(X => X.ORDR)
          //.WithOne()
          //.HasForeignKey("USaleNum")
       ...
       .HasForeignKey(x => x.K_PassportId);
...

        {
            ...
            modelBuilder.Entity<K_Order>(entity =>
            {
                entity.ToTable("K_Order");

                entity.Property(e => e.JobId).HasColumnName("JobId").ValueGeneratedOnAdd();
            });
            ...
            modelBuilder.Entity<ORDR>(entity =>
            {
                ...
                entity.Property(e => e.CardCode).HasColumnType("string");
            });
